...
export default function PriceEstimator({
  ...
  return (
    <div className="rounded-[1.75rem] border border-slate-200/80 bg-gradient-to-br from-slate-100 via-slate-50 to-stone-100 p-5 shadow-[0_16px_48px_rgba(15,23,42,0.28)] sm:p-6">
