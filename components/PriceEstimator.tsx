...
export default function PriceEstimator({
  ...
  return (
    <div className="rounded-[1.75rem] border border-slate-200/80 bg-gradient-to-br from-slate-50 via-white to-slate-100 p-5 shadow-[0_12px_40px_rgba(15,23,42,0.20)] sm:p-6">
