              ...
              <div className="max-w-2xl">
                ...
                <div className="mt-8 flex flex-wrap gap-2.5">
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 rounded-xl border border-emerald-300/60 bg-gradient-to-b from-emerald-500 to-emerald-700 px-6 py-3 text-sm font-bold tracking-tight text-white shadow-[0_6px_18px_rgba(5,150,105,0.45),inset_0_1px_0_rgba(255,255,255,0.25)] ring-1 ring-black/10 transition-all duration-300 hover:from-emerald-400 hover:to-emerald-600 hover:shadow-[0_10px_26px_rgba(5,150,105,0.6),inset_0_1px_0_rgba(255,255,255,0.3)] hover:-translate-y-0.5"
                  >
                  ...
                  <ScrollSaveLink
                    ...
                    className="inline-flex items-center gap-2 rounded-xl border border-sky-300/70 bg-gradient-to-b from-sky-400 to-sky-600 px-6 py-3 text-sm font-bold tracking-tight text-white shadow-[0_6px_18px_rgba(14,165,233,0.45),inset_0_1px_0_rgba(255,255,255,0.25)] ring-1 ring-black/10 transition-all duration-300 hover:from-sky-300 hover:to-sky-500 hover:shadow-[0_10px_26px_rgba(14,165,233,0.6),inset_0_1px_0_rgba(255,255,255,0.3)] hover:-translate-y-0.5"
                  >
                ...
                <div className="mt-5 flex flex-wrap items-center gap-2">
                  <a
                    ...
                    dir="ltr"
                    className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/[0.08] px-3.5 py-1.5 text-xs font-bold tracking-tight text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur-md transition-all duration-300 hover:border-white/45 hover:bg-white/[0.16]"
                  >
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-3.5 w-3.5 shrink-0" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/[0.05] px-3 py-1.5 text-[11px] font-bold tracking-tight text-white/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md">
                    <svg viewBox="0 0 24 24" fill="none" className="h-3.5 w-3.5 shrink-0" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7 10 L9 6 L15 6 L17 10 Z" fill="#FBBF24"/>
                      <path d="M3 14 L4 10 H20 L21 14 V16 H18.5 A1.5 1.5 0 0 1 15.5 16 H8.5 A1.5 1.5 0 0 1 5.5 16 H3 Z" fill="#FBBF24"/>
                      <circle cx="7" cy="16.5" r="1.8" fill="#1e293b"/>
                      <circle cx="17" cy="16.5" r="1.8" fill="#1e293b"/>
                    </svg>
                    {t.trustPills[1]}
                  </span>
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/[0.05] px-3 py-1.5 text-[11px] font-bold tracking-tight text-white/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" className="h-3 w-3 shrink-0 text-emerald-300" xmlns="http://www.w3.org/2000/svg">
