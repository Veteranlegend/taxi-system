            ...
            <div className="relative w-full p-7 sm:p-10 lg:p-14">
              <div className="max-w-2xl">
                ...
                <div className="mt-5 flex flex-wrap items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/[0.05] px-3 py-1.5 text-[11px] font-bold tracking-tight text-white/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="h-3 w-3 shrink-0 text-sky-400" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 12.75L10 17.75L20 7.75" />
                    </svg>
                    {t.trustPills[1]}
                  </span>
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/[0.05] px-3 py-1.5 text-[11px] font-bold tracking-tight text-white/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md">
