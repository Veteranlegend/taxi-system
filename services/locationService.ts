...
// Used to populate the pickup/destination pickers in the public booking flow.
// ---------------------------------------------------------------------------

export const TAXI_LOCATIONS: TaxiLocation[] = [
...
// ---------------------------------------------------------------------------
// Public service — location lookup only.
// ---------------------------------------------------------------------------

export const LocationService = {
  getLocations(): TaxiLocation[] {
    return TAXI_LOCATIONS;
  },

  getLocationById(id: string): TaxiLocation | undefined {
    return TAXI_LOCATIONS.find((l) => l.id === id);
  },
};
